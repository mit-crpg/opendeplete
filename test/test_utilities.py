...
class TestUtilities(unittest.TestCase):
    ...
    def test_evaluate_single_nuclide(self):
        ...
        y_ref = [6.6747328233649218e+08, 3.5519299354458231e+14,
                 3.6365476882517962e+14, 3.4256390766069800e+14]
    ...
    def test_evaluate_reaction_rate(self):
        ...
        x_ref = [0.0, 1296000.0, 2592000.0, 3888000.0]
        xe_ref = np.array([6.6747328233649218e+08, 3.5519299354458231e+14,
                           3.6365476882517962e+14, 3.4256390766069800e+14])
        r_ref = np.array([4.0643598574337771e-05, 3.8854747996543296e-05,
                          3.7250973881377225e-05, 4.3351961638697226e-05])
    ...
    def test_evaluate_eigenvalue(self):
        ...
        x_ref = [0.0, 1296000.0, 2592000.0, 3888000.0]
        y_ref = [1.1921986054449842, 1.178382697980056, 1.1734272259287073, 1.2091960735261975]
